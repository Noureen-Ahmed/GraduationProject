...
class NotificationCard extends StatelessWidget {
  ...
  String _getCourseCode(Announcement announcement) {
    // Extract course code from title or use default
    if (announcement.title.contains('Data Structures')) return 'COMP201';
    if (announcement.title.contains('Calculus')) return 'MATH202';
    if (announcement.title.contains('Physics')) return 'PHYS101';
    if (announcement.title.contains('Database')) return 'COMP301';
    if (announcement.title.contains('Web Development')) return 'COMP305';
    return 'COURSE';
  }

  String _getCourseName(Announcement announcement) {
    if (announcement.title.contains('Data Structures')) return 'Data Structures';
    if (announcement.title.contains('Calculus')) return 'Calculus II';
    if (announcement.title.contains('Physics')) return 'Physics I';
    if (announcement.title.contains('Database')) return 'Database Systems';
    if (announcement.title.contains('Web Development')) return 'Web Development';
    return 'Course';
  }
